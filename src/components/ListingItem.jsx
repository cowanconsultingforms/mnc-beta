...
const ListingItem = ({
  ...
  return (
    <Link
      ...
      to={
        isPropertyManagement
          ? `/property-management/${id}/tenants` // Route to tenant list if Property Management
          : `/category/${listing.type}/${id}` // Regular listing route otherwise
      }
    >
      <li
      ...
      >
        ...
        <div style={{ marginBottom: "25px" }}>
          ...
          <img
            className="grayscale h-[230px] w-full object-cover hover:scale-105 transition-scale duration-200 ease-in"
            loading="lazy"
