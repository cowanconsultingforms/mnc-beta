...
The handleAction prop is a function to be executed when the button is clicked, page is a string indicating the path to the page the button will link 
to, text is the text to be displayed inside the button, and idx is the id of the button's link.

Inside the NavBarButton component, the useAuth hook from reactfire is called to get the current user's authentication status.
